...
class OrderView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        order = Order.objects.filter(
            customer__user=self.request.user, status_id=2)
        context = {'items': order}
        template_str = render_to_string(
            template_name='customer/order_history.html', context=context)
...
class AddressView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        template_str = render_to_string(
            template_name='customer/address_list.html', context=context)
...
class ProfileView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        template_str = render_to_string(
            template_name='customer/profile.html', context=context)
...
class Dashboard(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = {'items': customer}
        template_str = render_to_string(
            template_name='customer/dashboard.html', context=context)
        return JsonResponse({'customer': template_str})
...
class PasswordChange(LoginRequiredMixin, FormView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = {'items': customer}
        template_str = render_to_string(
            template_name='customer/password.html', context=context)
