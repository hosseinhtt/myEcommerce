        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.CharField(
                        default="Country", help_text="Country name", max_length=50
                    ),
                ),
                (
                    "city",
                    models.CharField(
                        default="City", help_text="City name", max_length=50
                    ),
                ),
                (
                    "street",
                    models.CharField(
                        default="Address", help_text="Full Address", max_length=200
                    ),
                ),
                (
                    "zipcode",
